...
The above files are generated by the `resteasy-grpc` project(And part of the code is generated from the `.proto` file generated by the gRPC Java project by itself, which we won’t discuss the details here).
